...
use benben\Benben;
/**
 * FileCacheDependency class file.
 *
...
/**
 * FileCacheDependency represents a dependency based on a file's last modification time.
 *
 * FileCacheDependency performs dependency checking based on the
...
class FileCacheDependency extends CacheDependency
{
	...
	protected function generateDependentData()
	{
		if($this->fileName!==null)
			...
			throw new Exception(Benben::t('benben','FileCacheDependency.fileName cannot be empty.'));
	}
}
