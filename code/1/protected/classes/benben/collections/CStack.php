...
class CStack extends Component implements \IteratorAggregate,\Countable
{
	...
	public function copyFrom($data)
	{
		...
		elseif($data!==null)
			throw new Exception(Benben::t('benben','Stack data must be an array or an object implementing Traversable.'));
	}
	...
	public function peek()
	{
		if($this->_c)
			...
			throw new Exception(Benben::t('benben','The stack is empty.'));
	}
