...
/**
 * MysqlSchema is the class for retrieving metadata information from a MySQL database (version 4.1.x and 5.x).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class MysqlSchema extends DbSchema
{
	...
	public function renameColumn($table, $name, $newName)
	{
		...
		if($row===false)
			throw new DbException(Benben::t('benben','Unable to find "{column}" in table "{table}".',array('{column}'=>$name,'{table}'=>$table)));
