...
abstract class MessageSource extends ApplicationComponent
{
	...
	{
		return $this->_language===null ? Benben::app()->sourceLanguage : $this->_language;
	}
	 ...
	 * default handling. The {@link MissingTranslationEvent::message}
	 ...
	 * The {@link MissingTranslationEvent::message} property
