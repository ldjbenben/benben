 ...
 * the directory that contains the extension class file. When using Benben::t() to translate an extension message,
...
{
	const CACHE_KEY_PREFIX='Benben.PhpMessageSource.';
	...
	public function init()
	{
		...
		if($this->basePath===null)
			$this->basePath=Benben::getPathOfAlias('application.messages');
	}
	...
	protected function loadMessages($category,$language)
	{
		...
		if($this->cachingDuration>0 && $this->cacheID!==false && ($cache=Benben::app()->getComponent($this->cacheID))!==null)
		{
