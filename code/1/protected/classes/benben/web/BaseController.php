 ...
 * <ul>
 * <li>{@link ClipWidget Clips} : a clip is a piece of captured output that can be inserted elsewhere.</li>
...
abstract class BaseController extends Component 
{
	...
	*/
	public function renderFile($viewFile,$data=null,$return=false)
	{
		...
		if(($renderer=Benben::app()->getViewRenderer())!==null && $renderer->fileExtension==='.'.FileHelper::getExtension($viewFile))
	 ...
	 * This method is a shortcut to beginning {@link ClipWidget}.
	 * @param string $id the clip ID.
	 * @param array $properties initial property values for {@link ClipWidget}.
	 */
	public function beginClip($id,$properties=array())
	{
		$properties['id']=$id;
		$this->beginWidget('ClipWidget',$properties);
	}
	 ...
	 * any module, the default layout refers to the application's {@link WebApplication::layout default layout};
	 * If the controller belongs to a module, the default layout refers to the module's
	 * {@link WebModule::layout default layout}.
	...
	{
		$this->beginWidget('ContentDecorator',array('view'=>$view, 'data'=>$data));
	}
