...
class AccessControlFilter extends Filter
{
	 ...
	 * This property can be overridden by individual access rule via {@link AccessRule::message}.
	...
	protected function resolveErrorMessage($rule)
	{
		if($rule->message!==null)
			...
			return Benben::t('yii','You are not authorized to perform this action.');
	}
...
/**
 * AccessRule represents an access rule that is managed by {@link AccessControlFilter}.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id$
 * @package system.web.auth
...
class AccessRule extends Component
{
	 ...
	 * In this expression, you can use <code>$user</code> which refers to <code>Benben::app()->user</code>.
