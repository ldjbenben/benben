 ...
 *
 * @property array $roles Roles (name=>AuthItem).
 * @property array $tasks Tasks (name=>AuthItem).
 * @property array $operations Operations (name=>AuthItem).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id$
 ...
 * @since 1.0
 */
abstract class AuthManager extends ApplicationComponent implements IAuthManager
{
	/**
	...
	protected function checkItemChildType($parentType,$childType)
	{
		...
		if($parentType < $childType)
			throw new Exception(Benben::t('Benben','Cannot add an item of type "{child}" to an item of type "{parent}".',
