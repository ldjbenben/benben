...
use benben\Benben;
use benben\web\auth\BaseUserIdentity;
/**
 * UserIdentity.php class file
 *
...
/**
 * UserIdentity.php is a base class for representing identities that are authenticated based on a username and a password.
 *
 ...
 *
 * By default, UserIdentity.php assumes the {@link username} is a unique identifier
...
class UserIdentity extends BaseUserIdentity
{
	...
	{
		throw new Exception(Benben::t('yii','{class}::authenticate() must be implemented.',array('{class}'=>get_class($this))));
	}
