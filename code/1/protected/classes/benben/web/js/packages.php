...
return array(
	'jquery'=>array(
		'js'=>array(BENBEN_DEBUG ? 'jquery.js' : 'jquery.min.js'),
	),
	'yii'=>array(
	...
	'maskedinput'=>array(
		'js'=>array(BENBEN_DEBUG ? 'jquery.maskedinput.js' : 'jquery.maskedinput.min.js'),
		'depends'=>array('jquery'),
	),
	'cookie'=>array(
	...
	'bbq'=>array(
		'js'=>array(BENBEN_DEBUG ? 'jquery.ba-bbq.js' : 'jquery.ba-bbq.min.js'),
		'depends'=>array('jquery'),
	),
	'history'=>array(
	...
	'punycode'=>array(
		'js'=>array(BENBEN_DEBUG ? 'punycode.js' : 'punycode.min.js'),
	),
);
