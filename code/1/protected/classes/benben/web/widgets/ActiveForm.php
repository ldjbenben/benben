...
/**
 * ActiveForm provides a set of methods that can help to simplify the creation
 * of complex and interactive HTML forms that are associated with data models.
 *
 * The 'beginWidget' and 'endWidget' call of ActiveForm widget will render
 * the open and close form tags. Most other methods of ActiveForm are wrappers
 * of the corresponding 'active' methods in {@link Html}. Calling them in between
 * the 'beginWidget' and 'endWidget' calls will render text labels, input fields,
 * etc. For example, calling {@link ActiveForm::textField}
 * would generate an input field for a specified model attribute.
 *
 * What makes ActiveForm extremely useful is its support for data validation.
 * ActiveForm supports data validation at three levels:
 * <ul>
 ...
 * ActiveForm will render the error in the page back to user.</li>
 ...
 * the associated model class. ActiveForm is designed in such a way that
 ...
 * will support client-side validation only if it implements {@link Validator::clientValidateAttribute}
 * and has its {@link Validator::enableClientValidation} property set true.
 * At this moment, the following core validators support client-side validation:
 * <ul>
 * <li>{@link BooleanValidator}</li>
 * <li>{@link CaptchaValidator}</li>
 * <li>{@link CompareValidator}</li>
 * <li>{@link EmailValidator}</li>
 * <li>{@link NumberValidator}</li>
 * <li>{@link RangeValidator}</li>
 * <li>{@link RegularExpressionValidator}</li>
 * <li>{@link RequiredValidator}</li>
 * <li>{@link StringValidator}</li>
 * <li>{@link UrlValidator}</li>
 * </ul>
 *
 * ActiveForm relies on CSS to customize the appearance of input fields
 ...
 * validating, error and success. To differentiate these states, ActiveForm
 ...
 * {@link lientOptions} property or specifying in the {@link error} method.
 *
 * The following is a piece of sample view code showing how to use ActiveForm:
 *
 * <pre>
...
{
	/**
	 * @var mixed the form action URL (see {@link Html::normalizeUrl} for details about this parameter).
	...
	public $method='post';
	/**
	 * @var boolean whether to generate a stateful form (See {@link Html::statefulForm}). Defaults to false.
	 */
	 ...
	 * During the validation process, ActiveForm will set different CSS class for the container element
	 ...
	 * will be cancelled.
	 *
	 * Note that because this option refers to a js function, you should wrap the value with {@link JavaScriptExpressoin} to prevent it
	 ...
	 * that support it (see {@link Validator::enableClientValidation} and {@link Validator::clientValidateAttribute}).
	 *
	 * @see error
	 * @since 1.1.7
	 */
	 ...
	 * <li>'focus'=>'#'.Html::activeId($model,'username') - $model->username input field</li>
	...
	public function run()
	{
		...
		if(!$this->enableAjaxValidation && !$this->enableClientValidation || empty($this->attributes))
		{
			if($this->focus!==null)
			{
				...
				$cs->registerScript('ActiveForm#focus',"
	 ...
	 * This is similar to {@link Html::error} except that it registers the model attribute
	 * so that if its value is changed by users, an AJAX validation may be triggered.
	 * @param Model $model the data model
	 * @param string $attribute the attribute name
	 * @param array $htmlOptions additional HTML attributes to be rendered in the container div tag.
	 * Besides all those options available in {@link Html::error}, the following options are recognized in addition:
	 * <ul>
	 ...
	 * particular model attribute. For more details about these options, please refer to {@link lientOptions}.
	 ...
	 * This method is very similar to {@link Html::errorSummary} except that it also works
	...
	public function errorSummary($models,$header=null,$footer=null,$htmlOptions=array())
	{
		...
		{
			if($header===null)
				$header='<p>'.Benben::t('benben','Please fix the following input errors:').'</p>';
			if(!isset($htmlOptions['class']))
	 ...
	 * This method is a wrapper of {@link Html::activeLabel}.
	 * Please check {@link Html::activeLabel} for detailed information
	...
	/**
	 * Renders an HTML label for a model attribute.
	 * This method is a wrapper of {@link Html::activeLabelEx}.
	 * Please check {@link Html::activeLabelEx} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeUrlField}.
	 * Please check {@link Html::activeUrlField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeEmailField}.
	 * Please check {@link Html::activeEmailField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeNumberField}.
	 * Please check {@link Html::activeNumberField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeRangeField}.
	 * Please check {@link Html::activeRangeField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeDateField}.
	 * Please check {@link Html::activeDateField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeTextField}.
	 * Please check {@link Html::activeTextField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeHiddenField}.
	 * Please check {@link Html::activeHiddenField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activePasswordField}.
	 * Please check {@link Html::activePasswordField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeTextArea}.
	 * Please check {@link Html::activeTextArea} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeFileField}.
	 * Please check {@link Html::activeFileField} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	 ...
	 * This method is a wrapper of {@link Html::activeRadioButton}.
	 * Please check {@link Html::activeRadioButton} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeCheckBox}.
	 * Please check {@link Html::activeCheckBox} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	 ...
	 * This method is a wrapper of {@link Html::activeDropDownList}.
	 * Please check {@link Html::activeDropDownList} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 ...
	 * This method is a wrapper of {@link Html::activeListBox}.
	 * Please check {@link Html::activeListBox} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 * @param array $data data for generating the list options (value=>display)
	 ...
	 * This method is a wrapper of {@link Html::activeCheckBoxList}.
	 * Please check {@link Html::activeCheckBoxList} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	 ...
	 * This method is a wrapper of {@link Html::activeRadioButtonList}.
	 * Please check {@link Html::activeRadioButtonList} for detailed information
	 * about the parameters for this method.
	 * @param Model $model the data model
	 * @param string $attribute the attribute
	...
	public static function validate($models, $attributes=null, $loadInput=true)
	{
		...
		{
			if($loadInput && isset($_POST[ClassHelper::getModelLastName($model)]))
				$model->attributes=$_POST[ClassHelper::getModelLastName($model)];
