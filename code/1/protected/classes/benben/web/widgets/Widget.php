 ...
 *
 * Compared with {@link Controller controller}, a widget has neither actions nor filters.
 *
 * Usage is described at {@link BaseController} and {@link BaseController::widget}.
 *
 * @property BaseController $owner Owner/creator of this widget. It could be either a widget or a controller.
...
class Widget extends BaseController
{
	 ...
	 * When a widget is declared an action provider in {@link Controller::actions},
	...
	{
		$this->_owner=$owner===null ? Benben::app()->getController():$owner;
	}
	...
	public function getController()
	{
		if($this->_owner instanceof Controller)
			...
			return Benben::app()->getController();
	}
	...
	public function getViewPath($checkTheme=false)
	{
		...
		{
			if($checkTheme && ($theme=Benben::app()->getTheme())!==null)
			{
	...
	public function render($view,$data=null,$return=false)
	{
		if(($viewFile=$this->getViewFile($view))!==false)
			...
			throw new Exception(Benben::t('benben','{widget} cannot find the view "{view}".',
